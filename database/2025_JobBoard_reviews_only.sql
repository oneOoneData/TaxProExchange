-- TaxProExchange Job Board - Reviews Only Migration
-- Run this in your Supabase SQL Editor to add the missing review tables
...
-- 7. Create RLS policies for jobs table
...
-- 10. Create RLS policies for notification_prefs table
...
DO $$
BEGIN
  RAISE NOTICE 'Job Board reviews migration completed successfully!';
