...
// DELETE /api/admin/firm-workspaces/[id] - Delete a firm workspace
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ success: true, message: 'Firm workspace deleted successfully' });
  } catch (error) {
    console.error('Error deleting firm workspace:', error);
