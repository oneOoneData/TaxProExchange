      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="bg-slate-900 text-slate-100 rounded-lg p-6 my-6 overflow-x-auto">
...
4. Items requiring preparer review (bullet list)`}
              ...
              <button
                onClick={() => navigator.clipboard.writeText(document.querySelector('pre')?.innerText || '')}
...
**De-identification reminder:** Replace all client PII with [CLIENT NAME], [SSN-LAST4], [ADDRESS] before pasting. Re-identify in the final draft.`}
          ...
          <div className="mt-12 pt-8 border-t border-slate-200 text-center">
            ...
            <Link
              href="/insights/ai-tax-pro-second-brain"
