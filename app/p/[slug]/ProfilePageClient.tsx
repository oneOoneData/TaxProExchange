              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-3 mb-3">
                <h1 className="text-2xl sm:text-3xl font-semibold text-slate-900 flex items-center gap-2">
                  {profile.profile_type === 'firm_admin' && (
                    <span className="inline-flex items-center justify-center w-6 h-6 rounded bg-gradient-to-br from-yellow-400 via-amber-500 to-yellow-600 border-2 border-yellow-500 shadow-md" title="Premium Firm Member">
