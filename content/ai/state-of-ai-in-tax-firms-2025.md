...
- The CPA pipeline is collapsing; retirements alone would shrink the profession by nearly 70% over the next decade, per [CPAClub’s analysis of AICPA data](https://cpaclub.cpa/the-impact-of-the-retirement-of-75-of-cpas-on-the-accounting-industry).
...
- Section 7216 and broader data-security rules make “I tried ChatGPT” a liability without vetted vendors and consent workflows, as detailed in [The Tax Adviser’s overview of Sec. 7216 obligations](https://www.thetaxadviser.com/issues/2024/jan/the-many-implications-of-sec-7216). For internal guidance, see our [§7216](/ai/7216) deep dive.
...
* ☐ Section 7216-compliant consent workflows and documentation (see [§7216](/ai/7216) guide)
...
* [§7216](/ai/7216)-aligned consent workflows
...
Not necessarily, but you **do** need a vendor running a **proprietary or securely fine-tuned model**, not a generic GPT wrapper. Public models without strict isolation create [§7216](/ai/7216) and confidentiality risk. Your vendor must control how the model is deployed, secured, and audited.
...
No. Public LLMs (ChatGPT, Claude, Gemini, etc.) are not [§7216](/ai/7216)-compliant. Sending taxpayer data to a general-purpose system means:
...
Even “private modes” or “enterprise plans” don’t make public LLMs compliant. Any taxpayer info (names, income, EINs, W-2 images, K-1 data) routed through these systems creates [§7216](/ai/7216) risk.
