---
title: "Solomon AI Review: Automating Workpapers for Tax Firms"
description: "Hands-on review of Solomon AI — an AI platform that automates tax workpaper preparation, trial balance tie-out, and review. Based on Reddit practitioner reviews, feature analysis, and real-world use cases."
date: 2026-06-04
...
|------|----------|-------------------|
| **Solomon** | Workpaper automation | Learns from reviewer adjustments over time |
| **SurePrep** | Document automation | 1040-focused, massive existing user base |
| **Black Ore** | Full return prep | End-to-end AI prep from source docs |
| **Gruntworx** | Data extraction | OCR and classification for source documents |
...
*Have experience with Solomon? [Vote and leave your review](/insights/tools/solomon) to help other tax pros make the right call.*
